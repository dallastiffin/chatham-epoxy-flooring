/**
 * Chatham Epoxy Flooring — website lead handler
 * ============================================
 *
 ...
 */
function doGet() {
  return reply(true, 'Chatham Epoxy Flooring lead endpoint is running.');
}
...
function sendAlert(data) {
  ...
  MailApp.sendEmail({
    to: NOTIFY_EMAIL,
    subject: 'New estimate request: ' + (data.service || 'Chatham Epoxy Flooring'),
    body: lines.join('\n'),
